      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-24">
        {(eyebrow || title || description) && (
          <div className="mb-10 max-w-3xl md:mb-14">
            {eyebrow ? <p className={cn("mb-4 text-xs font-semibold uppercase tracking-[0.24em]", invert ? "text-white/60" : "text-black/55")}>{eyebrow}</p> : null}
            {title ? <h2 className="max-w-4xl text-3xl font-semibold tracking-[-0.04em] md:text-5xl">{title}</h2> : null}
