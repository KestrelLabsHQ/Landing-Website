    ...
    >
      <div className="grid gap-px border border-black/10 bg-black/10 lg:grid-cols-2">
        {servicesPage.map((service) => (
          <article key={service.title} className="bg-white p-6 md:p-8">
            <h2 className="text-2xl font-semibold tracking-[-0.04em] md:text-3xl">{service.title}</h2>
            <p className="mt-4 text-sm leading-6 text-black/68">{service.description}</p>
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-black/45">What it helps with</p>
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-black/45">Who it’s for</p>
                <p className="mt-3 text-sm leading-6 text-black/78">{service.for}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-black/45">Outcome</p>
